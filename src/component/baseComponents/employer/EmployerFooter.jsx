    ...
    <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-4">
            <li><a href="#" className="text-base text-gray-400 hover:text-white">Job Posting</a></li>
            <li><a href="#" className="text-base text-gray-400 hover:text-white">Candidate Sourcing</a></li>
            <li><a href="#" className="text-base text-gray-400 hover:text-white">Applicant Tracking</a></li>
            <li><a href="#" className="text-base text-gray-400 hover:text-white">Enterprise</a></li>
          </ul>
        </div>
        <div>
          ...
          <ul className="mt-4 space-y-4">
            ...
            <li><a href="#" className="text-base text-gray-400 hover:text-white">Resources</a></li>
          </ul>
        </div>
        <div>
      ...
      <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
        ...
        <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
          © 2025 GenAi, Inc. All rights reserved.
        </p>
      </div>
    </div>
  </footer>
