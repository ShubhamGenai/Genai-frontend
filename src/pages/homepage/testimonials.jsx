...
const TestimonialCard = ({ title, content, name, role, image }) => (
  <div className="bg-white border border-gray-300 rounded-lg p-6 h-[370px] flex flex-col justify-between transform transition duration-300 hover:scale-105 hover:shadow-xl">
    <div>
