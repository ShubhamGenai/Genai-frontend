  ...
  return (
    <section className="mt-6">
      <div className="flex md:px-6 pb-5 items-center justify-center">
        <div className="flex items-center justify-center gap-4 sm:gap-8 md:gap-18 flex-wrap">
          <img
            src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/ab/Meta-Logo.png/1200px-Meta-Logo.png?20211104123859"
            alt="Meta logo"
            width={80}
            className="opacity-90 grayscale transition duration-300 hover:opacity-100 hover:grayscale-0"
          />
          <img
