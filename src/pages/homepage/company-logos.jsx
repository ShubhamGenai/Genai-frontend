export default function CompanyLogos() {
  return (
    <section className="mt-6">
      ...
      <div
        className="scrolldown mb-24 ml-[15px] h-[50px] w-[30px] rounded-[50px] border-[2px] relative"
        style={{ "--color": "#2B7FFF", borderColor: "var(--color)" }}
      >
        <div className="chevrons -ml-[2px] mt-12 w-[30px] flex flex-col gap-1 items-center pt-2">
          <div
