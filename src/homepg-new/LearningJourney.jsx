  ...
  return (
    <div className="">
      <div className=" ">
        ...
        {/* Job Section */}
        <div className="bg-blue-600 text-white p-8  shadow flex flex-col md:flex-row items-center">
          <div className="flex-1 mb-6 p-10 md:mb-0 ml-20">
            <div className="flex items-center gap-3 mb-4">

              <h2 className="text-3xl "><span className="font-bold">Unlock Exclusive  </span> Benefits with <br /><span className="">Elite Subscription</span></h2>
            </div>
            <p className="mb-4 text-1xl">
              Upgrade to Elite and enjoy priority access, premium content, and exclusive<br /> perks designed for our top-tier members. Elevate your experience today!       </p>
