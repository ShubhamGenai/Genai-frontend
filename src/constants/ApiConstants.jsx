...
// export const API_BASE_URL =(import.meta.env.VITE_API_BASE_URL || "https://api.genailearning.in") + "/api";
...
export const CONTENTMANAGER = {
  ...
  UPLOAD_PROGRESS:`${API_BASE_URL}/content/upload-progress`,
  ...
  GET_LIBRARY_DOCUMENT_BY_ID:(id) => `${API_BASE_URL}/content/library-document/${id}`,
  UPDATE_LIBRARY_DOCUMENT:(id) => `${API_BASE_URL}/content/library-document/${id}`,
  DELETE_LIBRARY_DOCUMENT:(id) => `${API_BASE_URL}/content/library-document/${id}`,
